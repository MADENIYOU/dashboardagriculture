  ...
  return (
    <StyledWrapper>
        ...
        <div className="card">
            ...
            <span className="circle circle5 svg">
          ...
          <div className="content">
            <span className="title">AgroSEN Info</span>
            <span className="text">Découvrez en temps réel toutes les infos sur l'agriculture sénégalaise</span>
          </div>
